...
The package documentation is at http://harvestchoice.github.io/hc-api3. Documentation for each API method may be accessed using =/man/<method>=, for example at http://hcapi.harvestchoice.org/ocpu/library/hcapi3/man/getLayer/html
