...
*2014.11.11*: changed data storage from sqlite database to persistent Rserve session (faster). rApache and RSQLite seemed to have a library conflict.

*2014.11.11*: added a new argument =wkt= to =getLayer= method to support point/polygon summaries.
